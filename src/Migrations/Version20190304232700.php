 ...
 */
final class Version20190304232700 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE time (id INT AUTO_INCREMENT NOT NULL, day_id INT DEFAULT NULL, brone_id INT DEFAULT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_6F9498459C24126 (day_id), INDEX IDX_6F949845C643D61D (brone_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles VARCHAR(255) DEFAULT \'USER\' NOT NULL COLLATE utf8_general_ci');
    }
}
