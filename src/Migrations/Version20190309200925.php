 ...
 */
final class Version20190309200925 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recall (id INT AUTO_INCREMENT NOT NULL, master_id INT DEFAULT NULL, user_id INT DEFAULT NULL, text LONGTEXT NOT NULL, date DATETIME NOT NULL, INDEX IDX_4B30057613B3DB11 (master_id), INDEX IDX_4B300576A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
