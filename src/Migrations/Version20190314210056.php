 ...
 */
final class Version20190314210056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profile ADD category_id INT DEFAULT NULL, CHANGE telephone telephone VARCHAR(255) NOT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8157AA0F12469DE2 ON profile (category_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8157AA0F12469DE2 ON profile');
        $this->addSql('ALTER TABLE profile DROP category_id, CHANGE telephone telephone VARCHAR(11) NOT NULL COLLATE utf8mb4_unicode_ci');
