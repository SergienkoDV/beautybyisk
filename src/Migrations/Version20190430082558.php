 ...
 */
final class Version20190430082558 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ads (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, title VARCHAR(255) NOT NULL, text LONGTEXT NOT NULL, date DATETIME NOT NULL, INDEX IDX_7EC9F620F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE profile DROP INDEX FK_8157AA0F12469DE2, ADD UNIQUE INDEX UNIQ_8157AA0F12469DE2 (category_id)');
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles JSON NOT NULL, CHANGE master master VARCHAR(255) NOT NULL, CHANGE view view INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE profile DROP INDEX UNIQ_8157AA0F12469DE2, ADD INDEX FK_8157AA0F12469DE2 (category_id)');
        ...
        $this->addSql('ALTER TABLE user CHANGE roles roles VARCHAR(255) NOT NULL COLLATE utf8_general_ci, CHANGE master master VARCHAR(255) DEFAULT NULL COLLATE latin1_swedish_ci, CHANGE view view INT DEFAULT 0');
    }
}
