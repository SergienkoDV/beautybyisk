 ...
 */
final class Version20190314214154 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE worksheets (id INT AUTO_INCREMENT NOT NULL, master_id INT DEFAULT NULL, section_id INT DEFAULT NULL, INDEX IDX_F74EE77D13B3DB11 (master_id), INDEX IDX_F74EE77DD823E37A (section_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE worksheets ADD CONSTRAINT FK_F74EE77D13B3DB11 FOREIGN KEY (master_id) REFERENCES profile (id)');
        $this->addSql('ALTER TABLE worksheets ADD CONSTRAINT FK_F74EE77DD823E37A FOREIGN KEY (section_id) REFERENCES section (id)');
